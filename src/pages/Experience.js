            ...
            <div className="mx-3">
                ...
                <div className='vertical-timeline'>
                    ...
                    <div className="mx-auto experience p-4 rounded-3 position-relative">
                        ...
                        <div className="mb-2 fw-bold experienceHeadings">Web Developer</div>
                        <div className="mb-2 fw-bold experienceHeadings">uCertify</div>
                        <div className="mb-2">Front-end development for a variety of Shopify stores such as FitazFK, Rider Collective, Masseuse Massage, Francesca Jewellery and Salty Captain. Developed high quality landing pages and front end features using HTML, CSS, SCSS, JavaScript and Liquid.</div>
